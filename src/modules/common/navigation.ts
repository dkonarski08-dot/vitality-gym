...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'sales', label: 'Продажби', icon: '🛒', href: '/sales', roles: ['admin', 'receptionist'] },
  { key: 'inventory', label: 'Склад', icon: '📦', href: '/inventory', roles: ['admin', 'receptionist'] },
  ...
  { key: 'clients', label: 'Клиенти', icon: '👥', href: '/clients', roles: ['admin', 'receptionist'] },
